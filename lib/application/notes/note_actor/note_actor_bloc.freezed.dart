...
mixin _$NoteActorState {
  ...
  Result when<Result extends Object>({
    ...
    @required Result actionProgress(),
  ...
  Result map<Result extends Object>({
    ...
    @required Result actionProgress(_ActionProgress value),
  ...
  Result maybeMap<Result extends Object>({
    ...
    Result actionProgress(_ActionProgress value),
